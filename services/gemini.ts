...
export const searchPlaces = async (
  ...
  try {
    ...
    return {
      text: response.text || "I couldn't find any specific places matching that request.",
...
export const sendChatMessage = async (
  ...
  try {
    ...
    const chat = ai.chats.create({
      ...
      config: {
        systemInstruction: "You are a knowledgeable and friendly AI assistant specializing in Seoul, South Korea tourism and dining. Be helpful, polite, and enthusiastic."
      }
    });
